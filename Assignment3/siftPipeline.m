function [points, sift] = siftPipeline(original_image, kernel_size, th, spatial_size, wsigma)
...
%     hold on;
    ...
    for n = 1:size(keypoint, 1)
        ...
        coordinate_tmp = coordinate_tmp.*radius;
        points = [points; coordinate_tmp];
